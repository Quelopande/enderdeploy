    <nav>
        ...
        <div class="sidebar">
            <ul>
                ...
                <a href="/support"><li id="2"><i class="fa-regular fa-life-ring"></i> <p class="overTxt" id="overTxt">Soporte</p></li></a>
                <a href=""><li id="3"><i class="fa-solid fa-chart-line"></i> <p class="overTxt">Estado servicio</p></li></a>
                <a href="/services"><li id="4"><i class="fa-solid fa-plus"></i> <p class="overTxt">Nuevo Servicio</p></li></a>
                <a href="/settings"><li id="5"><i class="fa-solid fa-gear"></i> <p class="overTxt">Opciones</p></li></a>
