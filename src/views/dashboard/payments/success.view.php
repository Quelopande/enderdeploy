...
<head>
    ...
    <meta name="twitter:title" content="EnderDeploy - Pago realizado">
    ...
    <meta property="og:title" content="EnderDeploy - Pago realizado"/>
    ...
    <!-- EnderDeploy -->
    <title>EnderDeploy - Pago realizado</title>
    <link rel="website icon" type="ico" href="/assets/img/logo.ico">
    <link rel="stylesheet" href="/assets/styles/dashboard/payment.css">
    <link href="https://pro.fontawesome.com/releases/v6.0.0-beta1/css/all.css" rel="stylesheet"/>
</head>
<body style="--bg-theme-page: rgb(170, 249, 191); --txt-theme-page: rgb(23, 163, 40);">
    <h1><i class="fa-sharp fa-solid fa-badge-check"></i> <br>Pago realizado</h1>
    <p>Pago completado correctamente, por favor verifique que todo esté c</p>
