...
<head>
    ...
    <link rel="stylesheet" href="/assets/styles/dashboard/subscriptions.css">
...
<body data-page-id="4">
    ...
    <main class="separate">
        ...
        <div class="containers">
            ...
            <a class="container" href="/dashboard/subscriptionManagement?subscriptionId=<?php echo htmlspecialchars($subscription['subscriptionId'], ENT_QUOTES, 'UTF-8'); ?>">
        ...
        <?php if(!empty($subscriptionErrors)): ?>
        <div>
		    <ul><?php echo htmlspecialchars($subscriptionErrors); ?></ul>
		</div>
        <?php endif; ?>	
    </main>
    <div class="modal" id="modal">
        <form action="<?php echo htmlspecialchars('/dashboard/subscriptions'); ?>" method="post">
            <h1>Crear servicio</h1>
            <div class="first">
                <input type="text" name="subscriptionName" id="subscriptionName" required>
                <p>.enderdeploy.space</p>
            </div>
            <select name="subscriptionVersion" id="subscriptionVersion" required>
