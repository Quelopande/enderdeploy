    <nav>
        ...
        <div class="sidebar">
            <ul>
                ...
                <a href="https://uptime.rendercores.online/"><li id="3"><i class="fa-solid fa-chart-line"></i> <p class="overTxt">Estado servicio</p></li></a>
                <a href="/dashboard/subscriptions"><li id="4"><i class="fa-solid fa-plus"></i> <p class="overTxt">Nuevo Servicio</p></li></a>
